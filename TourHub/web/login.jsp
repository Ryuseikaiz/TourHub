                ...
                <div class="row gy-5 justify-content-center">
                    ...
                    <div class="col-12 col-lg-5 d-flex align-items-center">
                        <div class="d-flex gap-3 flex-column w-100">
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=https://tourhub.azurewebsites.net/login&response_type=code&client_id=969957597236-ss9e1vcfd3f8p7p16joll4t4ipgubm44.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger"> 
